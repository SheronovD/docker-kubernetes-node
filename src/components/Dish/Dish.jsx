...
const Dish = ({
	...
	const editDish = async () => {
		let newDishName = prompt('Введите новое описание задачи', dishName);
	...
	const removeDish = async () => {
		...
		if (confirm(`Задача '${dishName}' будет удалена. Продолжить?`)) {
	...
	return(
		<div className="pa-cook-dish">
			<div className="pa-cook-dish-text">
				{dishName}
			</div>
			<div className="pa-cook-dish-controls">
				<div className="pa-cook-dish-controls-row">
					<div 
						className="pa-cook-dish-controls-icon left-arrow-icon"
						onClick = {moveDishBack}
					></div>
					<div
						className="pa-cook-dish-controls-icon right-arrow-icon"
						onClick = {moveDishForward}
					></div>
				</div>
				<div className="pa-cook-dish-controls-row">
					<div
						className="pa-cook-dish-controls-icon edit-icon"
						onClick = {editDish}
					></div>
					<div
						className="pa-cook-dish-controls-icon delete-icon"
						onClick = {removeDish}
					></div>
				</div>
			</div>
