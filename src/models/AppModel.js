const getCooks = async () => {
	const response = await fetch('http://192.168.39.151:4321/cooks');
...
const addDish = async ({ cookId, dishName }) => {
	const response = await fetch(`http://192.168.39.151:4321/cooks/${cookId}/dishes`, {
		method: 'POST',
...
const editDish = async ({ cookId, dishId, newDishName }) => {
	const response = await fetch(`http://192.168.39.151:4321/cooks/${cookId}/dishes/${dishId}`, {
		method: 'PATCH',
...
const moveDish = async ({ cookId, dishId, destCookId }) => {
	const response = await fetch(`http://192.168.39.151:4321/cooks/${cookId}`, {
		method: 'PATCH',
